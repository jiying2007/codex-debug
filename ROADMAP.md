...
- [x] real historical corpus with 4 unique reviewed direct-parent transitions across Codex Debug, Safe Core and Codex Diagnose; repository and failure-kind floors are met
...
- [x] three authentic insufficient-evidence variants are attached to reviewed Debug, Safe Core and Diagnose transitions; structural coverage is now `4/12` reviewed cases, `3/3` repositories, `4/4` failure kinds, `3/3` insufficient variants and `7` model-evaluation views
- [x] Promotion Provenance continues to prove exactly 4 historical transitions; insufficient variants never inflate provenance or qualification transition counts
- [x] package / package-lock / product-contract development identity is gated as one version (`0.1.6` for this line)
